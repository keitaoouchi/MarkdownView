// Extended languages bundle — registers 97 additional hljs languages
// on the shared window._hljs instance exposed by the core bundle.
// Does NOT call initRenderer, preserving plugin state and window.renderMarkdown.
...
if (hljs) {
  ...
  // Re-highlight any code blocks already rendered with core-only languages
